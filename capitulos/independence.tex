...
\end{multline}
onde utilizamos a independência de $X$ e $Y$ na segunda igualdade.
...
Pelo Teorema da Convergência Monótona (usado duas vezes) temos
\begin{equation}
...
\todo{problema princesa/posto-de-gasolina? Aqui?}
...
\begin{definition}
  ...
  \end{equation}
  Chamamos $\mathcal{F}_c$ de $\sigma$-álgebra caudal. \index{sigma-algebra@$\sigma$-álgebra!caudal}
\end{definition}
...
\begin{exercise}
  ...
  \end{enumerate}
\end{exercise}
\todo{trocar polones por $\mathbb{R}$}
