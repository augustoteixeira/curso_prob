...
A essa probabilidade em $E \times E'$ damos o nome de distribuição conjunta deste par. \index{distribuicao@distribuição!conjunta}.
...
% \end{exercise}
% HUBERT: Nao entendi o sentido de P(\cdot|A|B).
