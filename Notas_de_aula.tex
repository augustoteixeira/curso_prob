...
Denotaremos $\alpha$ sempre por $\Omega$ o nosso espaço amostral (à princípio qualquer conjunto).
...
Nesse caso, se $X: \Omega \to E$ é uma função $(\mathcal{F}, \mathcal{A})$-mensurável, dizemos que $X$ é um elemento aleatório em $(\Omega, \mathcal{F})$ tomando valores em $E$, ou um $E$-elemento aleatório.
