...
\section{Relembrar é viver...}

Fazer Caratheodory com continuidade no vazio. Por exemplo simplifica um pouco a extensão de Kolmogorov.
...
\subsection{Espaços produto}

\subsection{Distribuições conjuntas}

\subsection{Acoplamentos}

Talvez valha a pena escrever sobre acoplamentos de maneira geral. Talvez pegando algo do Pascal Massart. Vale a pena tentar escrever algo sobre: composiçao de acoplamentos, quando um acoplamento ``dá errado''...
...
\todo{mandar Kolmogorov para o final (próximo a núcleos de transição, talvez) e dar produtos de espaços não canonicos no início}
...
\todo{mudar a prova do teorema da extensão de Kolmogorov: trocar retângulos por cilindros do tipo AxRxRx... (para o enunciado podemos até usar semiretas, depois Dynkin). o espaço mensuravel (E,A) vai para o final, sempre denotando canonicos.}
...
\ifdraft{\newpage \subsection{Tópico: Teorema de Uma Série} fazer...}{}

\ifdraft{\newpage \subsection{Tópico: Uma dinâmica em \texorpdfstring{$[0,1]$}{[0,1]}} fazer dinâmica 2x mod 1 e relações Lebesgue[0,1] com produtos de bernoulli}{}
...
\ifdraft{\newpage \subsection{Tópico: Distribuições de Extremos} fazer...}{}
...
\ifdraft{\newpage \subsection{Tópico: Grafos Aleatórios} fazer erdos renyi...}{}

\ifdraft{\newpage \subsection{Tópico: Currie Weiss} fazer...}{}
...
\ifdraft{\newpage \subsection{Tópico: Análise de DNA} fazer "computational molecular biology" - Pevzner seção 5.5...}{}

\ifdraft{\newpage \subsection{Tópico: Contando triângulos} números de triângulos em grafos (olhar alon spencer)...}{}
...
\ifdraft{\newpage \subsection{Tópico: Entropia de Shannon} fazer...}{}

\ifdraft{\newpage \subsection{Tópico: Processos de renovação} fazer...}{}
...
\ifdraft{\newpage \subsection{Tópico: Processos de ramificação} fazer...}{}
...
\ifdraft{\newpage \subsection{Tópico: Análise de componentes principais} variáveis gaussianas e principal component analysis...}{}

\ifdraft{\newpage \subsection{Tópico: Funções características???} funcoes caracteristicas e tomografia...}{}
...
\ifdraft{\newpage \subsection{Tópico: Urna de Pólya} fazer...}{}

\ifdraft{\newpage \subsection{Tópico: Recorrência e transiência} markov recorrência/transiência + periodicidade...}{}
...
\ifdraft{\newpage \subsection{Tópico: Martingais a tempo discreto} fazer...}{}

\ifdraft{\newpage \subsection{Tópico: Propriedade fraca de Markov} mostrar que cadeias = processos...}{}
...
\ifdraft{\newpage \subsection{Tópico: Processos de Poisson em \texorpdfstring{$\mathbb{R}$}{R}} fazer...}{}

\ifdraft{\newpage \subsection{Tópico: Processos de Markov em tempo contínuo} fazer...}{}

\ifdraft{\newpage \subsection{Tópico: Sistemas de partículas} fazer...}{}
