...
Um outro caso importante a ser estudado de construção de espaços de probabilidade se refere ao caso em que $\Omega = \mathbb{R}$.
Esse exemplo será muito importante no que segue ao nos ajudar a entender distribuições de variáveis aleatórias.
...
\todo{Fazer Caratheodory com continuidade no vazio. Por exemplo simplifica um pouco a extensão de Kolmogorov.}
